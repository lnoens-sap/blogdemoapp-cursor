...
module.exports = "# Spanish i18n file\n# App Title\nAppTitle=Gestor de Productos\n\n# Navigation Labels\nProducts=Productos\nCreateProduct=Crear Producto\nEditProduct=Editar Producto\nProductDetails=Detalles del Producto\n\n# Field Labels\nProductName=Nombre del Producto\nPrice=Precio\nSupplier=Proveedor\nID=ID\n\n# Action Buttons\nSave=Guardar\nCancel=Cancelar\nDelete=Eliminar\nEdit=Editar\nCreate=Crear\nBack=Atrás\n\n# Messages\nProductCreatedSuccess=Producto creado exitosamente\nProductUpdatedSuccess=Producto actualizado exitosamente\nProductDeletedSuccess=Producto eliminado exitosamente\nDeleteConfirmation=¿Está seguro de que desea eliminar este producto?\nErrorOccurred=Ocurrió un error\nLoading=Cargando...\n\n# Menu Items\nAbout=Acerca de\nSupport=Soporte\nUserActivityLog=Registro de Actividad del Usuario\n\n# General Labels\nGeneralInformation=Información General\nDetails=Detalles\nActions=Acciones\n\n# Existing keys from generated project\nProducts_Detail=Detalles de Productos\nCreate_Products_Detail=Crear Detalles de Productos\nUpdate_Products_Detail=Actualizar Detalles de Productos\n"
...
let blogdemoappcursor_actions_blogmobiledemodestination3_service_closeoffline_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOffline.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOffline.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_closeofflinefailuremessage_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineFailureMessage.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineFailureMessage.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_closeofflinesuccessmessage_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineSuccessMessage.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineSuccessMessage.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_downloadoffline_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadOffline.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadOffline.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_downloadstartedmessage_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadStartedMessage.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadStartedMessage.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_initializeoffline_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOffline.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOffline.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_initializeofflinefailuremessage_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOfflineFailureMessage.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOfflineFailureMessage.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_syncfailuremessage_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_syncstartedmessage_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncStartedMessage.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncStartedMessage.action")
let blogdemoappcursor_actions_blogmobiledemodestination3_service_uploadoffline_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/UploadOffline.action */ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/UploadOffline.action")
...
let blogdemoappcursor_actions_errorarchive_errorarchive_syncfailure_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/ErrorArchive/ErrorArchive_SyncFailure.action */ "./build.definitions/blogdemoappcursor/Actions/ErrorArchive/ErrorArchive_SyncFailure.action")
let blogdemoappcursor_actions_errorarchive_navtoerrorarchive_detail_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_Detail.action */ "./build.definitions/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_Detail.action")
let blogdemoappcursor_actions_errorarchive_navtoerrorarchive_list_action = __webpack_require__(/*! ./blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_List.action */ "./build.definitions/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_List.action")
...
let blogdemoappcursor_pages_errorarchive_errorarchive_detail_page = __webpack_require__(/*! ./blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_Detail.page */ "./build.definitions/blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_Detail.page")
let blogdemoappcursor_pages_errorarchive_errorarchive_list_page = __webpack_require__(/*! ./blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_List.page */ "./build.definitions/blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_List.page")
...
let blogdemoappcursor_rules_blogmobiledemodestination3_errorarchive_checkforsyncerror_js = __webpack_require__(/*! ./blogdemoappcursor/Rules/BlogMobileDemoDestination3/ErrorArchive_CheckForSyncError.js */ "./build.definitions/blogdemoappcursor/Rules/BlogMobileDemoDestination3/ErrorArchive_CheckForSyncError.js")
...
module.exports = {
	...
	blogdemoappcursor_actions_blogmobiledemodestination3_service_closeoffline_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_closeoffline_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_closeofflinefailuremessage_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_closeofflinefailuremessage_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_closeofflinesuccessmessage_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_closeofflinesuccessmessage_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_downloadoffline_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_downloadoffline_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_downloadstartedmessage_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_downloadstartedmessage_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_initializeoffline_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_initializeoffline_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_initializeofflinefailuremessage_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_initializeofflinefailuremessage_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_syncfailuremessage_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_syncfailuremessage_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_syncstartedmessage_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_syncstartedmessage_action,
	blogdemoappcursor_actions_blogmobiledemodestination3_service_uploadoffline_action : blogdemoappcursor_actions_blogmobiledemodestination3_service_uploadoffline_action,
	...
	blogdemoappcursor_actions_errorarchive_errorarchive_syncfailure_action : blogdemoappcursor_actions_errorarchive_errorarchive_syncfailure_action,
	blogdemoappcursor_actions_errorarchive_navtoerrorarchive_detail_action : blogdemoappcursor_actions_errorarchive_navtoerrorarchive_detail_action,
	blogdemoappcursor_actions_errorarchive_navtoerrorarchive_list_action : blogdemoappcursor_actions_errorarchive_navtoerrorarchive_list_action,
	...
	blogdemoappcursor_pages_errorarchive_errorarchive_detail_page : blogdemoappcursor_pages_errorarchive_errorarchive_detail_page,
	blogdemoappcursor_pages_errorarchive_errorarchive_list_page : blogdemoappcursor_pages_errorarchive_errorarchive_list_page,
	...
	blogdemoappcursor_rules_blogmobiledemodestination3_errorarchive_checkforsyncerror_js : blogdemoappcursor_rules_blogmobiledemodestination3_errorarchive_checkforsyncerror_js,
...
/***/ "./build.definitions/blogdemoappcursor/Rules/BlogMobileDemoDestination3/ErrorArchive_CheckForSyncError.js":
/*!****************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Rules/BlogMobileDemoDestination3/ErrorArchive_CheckForSyncError.js ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_Detail.page":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_Detail.page ***!
  \*****************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOffline.action":
/*!************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOffline.action ***!
  \************************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.OfflineOData.Close","Service":"/blogdemoappcursor/Services/BlogMobileDemoDestination3.service","Force":true,"ActionResult":{"_Name":"close"},"OnSuccess":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineSuccessMessage.action","OnFailure":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineFailureMessage.action":
/*!**************************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineFailureMessage.action ***!
  \**************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineSuccessMessage.action":
/*!**************************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/CloseOfflineSuccessMessage.action ***!
  \**************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadOffline.action":
/*!***************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadOffline.action ***!
  \***************************************************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/blogdemoappcursor/Services/BlogMobileDemoDestination3.service","DefiningRequests":[{"Name":"Products","Query":"Products"}],"_Type":"Action.Type.OfflineOData.Download","ActionResult":{"_Name":"sync"},"OnFailure":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action","OnSuccess":"/blogdemoappcursor/Rules/BlogMobileDemoDestination3/ErrorArchive_CheckForSyncError.js"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadStartedMessage.action":
/*!**********************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadStartedMessage.action ***!
  \**********************************************************************************************************************/
/***/ ((module) => {

module.exports = {"Message":"Download in progress...","CompletionMessage":"Download Successful","CompletionTimeout":7,"OnSuccess":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadOffline.action","_Type":"Action.Type.ProgressBanner"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOffline.action":
/*!*****************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOffline.action ***!
  \*****************************************************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/blogdemoappcursor/Services/BlogMobileDemoDestination3.service","DefiningRequests":[{"Name":"Products","Query":"Products"}],"_Type":"Action.Type.ODataService.Initialize","ShowActivityIndicator":true,"ActivityIndicatorText":"Downloading...","ActionResult":{"_Name":"init"},"OnFailure":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOfflineFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOfflineFailureMessage.action":
/*!*******************************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/InitializeOfflineFailureMessage.action ***!
  \*******************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action":
/*!******************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action ***!
  \******************************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncStartedMessage.action":
/*!******************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncStartedMessage.action ***!
  \******************************************************************************************************************/
/***/ ((module) => {

module.exports = {"Message":"Upload in progress...","CompletionMessage":"Sync completed","CompletionTimeout":7,"OnSuccess":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/UploadOffline.action","OnFailure":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action","_Type":"Action.Type.ProgressBanner"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/UploadOffline.action":
/*!*************************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/UploadOffline.action ***!
  \*************************************************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/blogdemoappcursor/Services/BlogMobileDemoDestination3.service","_Type":"Action.Type.OfflineOData.Upload","ActionResult":{"_Name":"sync"},"OnSuccess":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/DownloadStartedMessage.action","OnFailure":"/blogdemoappcursor/Actions/BlogMobileDemoDestination3/Service/SyncFailureMessage.action"}
...
/***/ "./build.definitions/blogdemoappcursor/Actions/ErrorArchive/ErrorArchive_SyncFailure.action":
/*!**************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/ErrorArchive/ErrorArchive_SyncFailure.action ***!
  \**************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.BannerMessage","Message":"Upload failed!","Duration":0,"Animated":false,"OnActionLabelPress":"/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_List.action","ActionLabel":"View Errors"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_Detail.action":
/*!**************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_Detail.action ***!
  \**************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_Detail.page","NavigationType":"Inner"}

/***/ }),

/***/ "./build.definitions/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_List.action":
/*!************************************************************************************************!*\
  !*** ./build.definitions/blogdemoappcursor/Actions/ErrorArchive/NavToErrorArchive_List.action ***!
  \************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/blogdemoappcursor/Pages/ErrorArchive/ErrorArchive_List.page","NavigationType":"Inner"}
...
module.exports = {"DestinationName":"BlogMobileDemoDestination3","OfflineEnabled":true,"LanguageURLParam":"","OnlineOptions":{},"OfflineOptions":{"StoreParameters":{}},"PathSuffix":"","SourceType":"Local","ServiceUrl":""}
